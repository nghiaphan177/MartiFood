        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimumOrderValue = table.Column<decimal>(type: "decimal(14,2)", precision: 14, scale: 2, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fee = table.Column<decimal>(type: "decimal(14,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Cost = table.Column<decimal>(type: "decimal(14,2)", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeDescription", "This is description of MartiFood" },
                    { "HomeKeyword", "This is keyword of MartiFood" },
                    { "HomeTitle", "This is home page of MartiFood" }
                });

            migrationBuilder.InsertData(
                table: "AppRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("8d04dce2-969a-435d-bba4-df3f325983dc"), "eb32c273-ed19-4563-8933-e68d27a891db", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AppUsers",
                columns: new[] { "Id", "AccessFailedCount", "CartId", "ConcurrencyStamp", "DOB", "Email", "EmailConfirmed", "FirstName", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("69bd714f-9576-45ba-b5b7-f00649be00de"), 0, null, "6c95e878-0946-49ef-b524-437a5b064b0e", new DateTime(2000, 7, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "phanthanhnghia127@gmail.com", true, "Nghia", "Phan", false, null, "phanthanhnghia127@gmail.com", "admin", "AQAAAAEAACcQAAAAEIP6y6tGhj4KKM+BaOEB9XLhL6wFRQLPZNT+nPcMVluwW11UTvdlgVvd+z+CBBi9Sw==", "0372401475", true, "", false, "admin" });
